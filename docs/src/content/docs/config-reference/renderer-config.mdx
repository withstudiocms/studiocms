...
This renderer is used to render MarkDoc content with React components. This allows you to use React components in your MarkDoc content. Requires [`@astrojs/react`](https://docs.astro.build/en/guides/integrations-guide/react/) to be installed.
