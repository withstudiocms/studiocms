...
StudioCMS requires atleast one of the [Encryption authentication variable](/start-here/environment-variables/#username-and-password) to be set in your `.env` file.
...
<ReadMore>
For more information about all the available authentication environment variables see, [Authentication Environment Variables](/start-here/environment-variables/#authentication-environment-variables) section.
</ReadMore>
