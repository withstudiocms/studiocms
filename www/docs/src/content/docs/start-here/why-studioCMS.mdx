...
- **Multiple Markdown Parsers:** In addition to `Marked`, you can use Markdoc, MDX, or even Astro's Built in Markdown parsers to process your markdown however you need.

- **Built-in Authentication:** We support multiple different OAuth providers for which you can provide your own tokens to customize your auth however you need.
