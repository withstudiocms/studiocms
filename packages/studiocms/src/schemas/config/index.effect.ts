...
import { DbConfigSchema } from './db.effect.js';
import { DeveloperConfigSchema } from './developer.effect.js';
import { SDKConfigSchema } from './sdk.effect.js';
...
export const StudioCMSOptionsSchema = Schema.Struct({
	...
	plugins: Schema.optional(Schema.Array(StudioCMSPluginSchema)).annotations({
