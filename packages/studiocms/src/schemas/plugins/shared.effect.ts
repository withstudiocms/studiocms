 ...
 */
export const AvailableDashboardPagesSchema = Schema.Struct({
	user: Schema.optional(Schema.Array(AvailableDashboardBaseSchema)),
	admin: Schema.optional(Schema.Array(AvailableDashboardBaseSchema)),
});
