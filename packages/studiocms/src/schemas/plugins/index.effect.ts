...
import { PluginTranslationsSchema } from './i18n.effect.js';
import {
	DashboardPageSchema,
 ...
 */
export const SafePluginListSchema = Schema.Array(SafePluginListItemSchema);
 ...
 */
export const SitemapConfigSchema = Schema.Struct({
 ...
 */
export const DashboardAugmentSchema = Schema.Struct({
 ...
 */
export const ImageServiceConfigSchema = Schema.Struct({
 ...
 */
export const AuthServiceConfigSchema = Schema.Struct({
...
export class astroConfigHookSchema extends BaseHookSchema.extend<astroConfigHookSchema>(
	...
	addIntegrations: FunctionSchema(
		Schema.Union(AstroIntegrationSchema, Schema.Array(AstroIntegrationSchema)),
		Schema.Void
	),
}) {}
