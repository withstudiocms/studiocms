 ...
 */
export const TranslationsJSONSchema = Schema.Record({
	key: Schema.String,
	value: Schema.String,
});
 ...
 */
export const ComponentsJSONSchema = Schema.Record({
	key: Schema.String,
 ...
 */
export const PluginTranslationsSchema = Schema.Record({
	key: Schema.String,
 ...
 */
export const PluginTranslationCollectionSchema = Schema.Record({
	key: Schema.String,
 ...
 */
export const AugmentsJSONSchema = Schema.Struct({
 ...
 * }
 */
export const PluginAugmentsTranslationCollectionSchema = Schema.Record({
	key: Schema.String,
