	...
	namedExports: [
		{
			...
			typeDef: `typeof import('${resolve('../../static/components/Avatar.astro')}').default`,
		},
		{
			name: 'FormattedDate',
			multiLineDescription: [
			...
			typeDef: `typeof import('${resolve('../../static/components/FormattedDate.astro')}').default`,
		},
		{
			name: 'GenericHeader',
			multiLineDescription: [
			...
			typeDef: `typeof import('${resolve('../../static/components/GenericHeader.astro')}').default`,
		},
		{
			name: 'Navigation',
			multiLineDescription: [
			...
			typeDef: `typeof import('${resolve('../../static/components/Navigation.astro')}').default`,
		},
		{
			name: 'Generator',
			typeDef: `typeof import('${resolve('../../static/components/Generator.astro')}').default`,
			multiLineDescription: [
