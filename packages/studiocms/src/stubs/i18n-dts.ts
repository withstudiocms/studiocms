...
i18nDTS.addModule('studiocms:i18n', {
	namedExports: [
		{
			name: 'staticPaths',
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').staticPaths`,
		...
		{
			name: 'getLangFromUrl',
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').getLangFromUrl`,
			multiLineDescription: [
		...
		},
		{
			...
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').useTranslations`,
			multiLineDescription: [
		...
		},
		{
			...
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').useTranslatedPath`,
			multiLineDescription: [
		...
		},
		{
			...
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').languageSelectorOptions`,
			multiLineDescription: [
		...
		},
		{
			...
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').getCurrentURLPath`,
			multiLineDescription: [
		...
		{
			name: 'switchLanguage',
			typeDef: `typeof import('${resolve('../../static/i18n/index.ts')}').switchLanguage`,
			multiLineDescription: [
	...
	typeExports: [
		{
			name: 'UiLanguageKeys',
			typeDef: `import('${resolve('../../static/i18n/index.ts')}').UiLanguageKeys`,
		},
		{
			name: 'UiTranslations',
			typeDef: `import('${resolve('../../static/i18n/index.ts')}').UiTranslations`,
		},
	],
});
