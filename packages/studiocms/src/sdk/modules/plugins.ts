		...
		effect: genLogger('studiocms/sdk/SDKCore/modules/plugins/effect')(function* () {
			...
			const usePluginData = (pluginId: string, entryId: string) =>
				genLogger('usePluginData')(function* () {
					 ...
					 */
					const select = Effect.fn(function* <T extends object>(validator?: ValidatorOptions<T>) {
					 ...
					 */
					const insert = Effect.fn(function* <T extends object>(
						data: T,
						validator?: ValidatorOptions<T>
					) {
					 ...
					 */
					const update = Effect.fn(function* <T extends object>(
						data: T,
						validator?: ValidatorOptions<T>
					) {
						// Check if the plugin data with the given ID exists
