...
/**
 * Type guard to check if a schema is of type Schema.All
 *
...
/**
 * Type helper to create a partial schema type with all fields optional except for 'id'.
 */
...
/**
 * Builds a partial schema from a given base schema, making all fields optional except for 'id'.
 *
 * @template Fields - The fields of the base schema
 * @param base - The base schema to build the partial schema from
 * @returns A new schema with all fields optional except for 'id'
 */
