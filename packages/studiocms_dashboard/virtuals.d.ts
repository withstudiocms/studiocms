...
declare module 'studiocms-dashboard:web-vitals' {
	export type WebVitalsResponseItem = import('./src/utils/webVital').WebVitalsResponseItem;
	export const getWebVitals: typeof import('./src/utils/webVital').getWebVitals;
}
