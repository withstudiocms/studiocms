...
export class WordPressAPIConverters extends Effect.Service<WordPressAPIConverters>()('WordPressAPIConverters', {
	...
	effect: genLogger('@studiocms/devapps/effects/WordPressAPI/converters.effect')(function* () {
		...
		const convertToPageData = (page: unknown, endpoint: string) =>
			genLogger('@studiocms/devapps/effects/WordPressAPI/converters.effect.convertToPageData')(function* () {
		...
		const generateCategories = (categories: number[], endpoint: string) =>
			genLogger('@studiocms/devapps/effects/WordPressAPI/converters.effect.generateCategories')(function* () {
		...
		const generateTags = (tags: number[], endpoint: string) =>
			genLogger('@studiocms/devapps/effects/WordPressAPI/converters.effect.generateTags')(function* () {
				const newTags: Tag[] = [];
		...
		const convertToPostData = (post: unknown, useBlogPkg: boolean, endpoint: string) =>
			genLogger('@studiocms/devapps/effects/WordPressAPI/converters.effect.convertToPostData')(function* () {
