/**
 * Seasonal Messages Interface
 */
export interface SeasonalMessages {
	messages: string[];
}

/**
 * Get seasonal messages based on the current date
 *
 * @returns An object containing an array of seasonal messages
 */
 ...
 *
 * @returns The current season as a Season type, or undefined if not in a special season
 */
