...
describe('TemplateEngine', () => {
	...
	describe('Basic functionality', () => {
		...
		it('should handle nested property access', () => {
			const result = engine.render('{{user.name}} works at {{user.company}}', {
		...
		it('should handle multiple variables', () => {
			const result = engine.render('{{greeting}} {{name}}, {{message}}', {
				greeting: 'Hello',
				name: 'Alice',
				message: 'welcome!',
			});
		...
		it('should handle missing variables in non-strict mode', () => {
			const result = engine.render('Hello {{name}}! Your age is {{age}}.', { name: 'Bob' });
		...
		it('should handle templates with no variables', () => {
			const result = engine.render('This is just plain text', { name: 'test' });
			expect(result).toBe('This is just plain text');
		});

		it('should handle deep nesting', () => {
			const result = engine.render('{{a.b.c.d}}', { a: { b: { c: { d: 'deep' } } } });
	...
	describe('Variable detection', () => {
		...
		it('should extract variable names from template', () => {
			const variables = engine.getVariables(
				'Hello {{name}}! You have {{count}} messages from {{sender.name}}.'
			);
	...
	describe('Default values', () => {
		it('should use default value for missing variables', () => {
			...
			const result = engineWithDefault.render('Hello {{name}}! Your role is {{role}}.', {
				name: 'Alice',
			});
